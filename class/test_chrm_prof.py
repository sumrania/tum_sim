...
cp = chpr.ChrmProf(len("AAABBBCCCDDDEEEFFF"))
print ''
...
cp2 = chpr.ChrmProf(len("RRRRRSSSSSTTTTTUUUUUVVVVV"))
print ''
...
cp3 = chpr.ChrmProf(len("XXXXYYYYZZZZ"))
print ''
...
cp4 = chpr.ChrmProf(len("RRRRRSSSSSTTTTTUUUUUVVVVV"))
print ''
...
cp5 = chpr.ChrmProf(len("RRRRRSSSSSTTTTTUUUUUVVVVV"))
print ''
